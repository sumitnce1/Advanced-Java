...
public class App {
    public static void main(String[] args) {
        try (AnnotationConfigApplicationContext applicationContext = new AnnotationConfigApplicationContext(
            ...
            int choice = 0;
            while (choice != 17) {
                System.out.println("Enter Choice[1to6 Users & 7-11 Category & 12-16 Product] : ");
                ...
                switch (choice) {
                    ...
                    case 6:
                        ...
                        System.out.println("Enter the username: ");
                        String userNamess = scanner.nextLine();
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        System.out.println("----Delete individual Category-----");
                        System.out.println("Enter the Category ID: ");
                        try {
                            int categoryIds = scanner.nextInt();
                            boolean catDelete = categoryDAO.deleteCategory(categoryIds);
                            if (catDelete) {
                                System.out.println("\u001B[32mCategory deleted successfully.\u001B[0m");
                            } else {
                                System.out.println("\u001B[31mOpps! Failed to delete category.\u001B[0m");
                            }
                        } catch (InputMismatchException e) {
                            System.out.println("\u001B[31mInvalid input. Please enter a valid Category ID.\u001B[0m");
                        }
                        break;
                    case 11:
                        System.out.println("----Update Category-----");
                        System.out.println("Enter the CategoryID: ");
                        int categoryIdss = scanner.nextInt();
                        scanner.nextLine();
                        System.out.println("Enter the categoryName: ");
                        String categoryNames = scanner.nextLine();
                        System.out.println("Enter the categoryDescription: ");
                        String categoryDescriptions = scanner.nextLine();
                        System.out.println("Enter the categoryImageUrl: ");
                        String categoryImageUrls = scanner.nextLine();
                        
                        try {
                            boolean isUpdated = categoryDAO.updateCategory(categoryIdss, categoryNames, categoryDescriptions, categoryImageUrls);
                            if (isUpdated) {
                                System.out.println("\u001B[32mCategory updated successfully.\u001B[0m");
                            } else {
                                System.out.println("\u001B[3s3mFailed to update category.\u001B[0m");
                            }
                        } catch (Exception e) {
                            System.out.println("\u001B[31mAn error occurred while updating the category: " + e.getMessage() + "\u001B[0m");
                        }
                        break;
                    case 12:
