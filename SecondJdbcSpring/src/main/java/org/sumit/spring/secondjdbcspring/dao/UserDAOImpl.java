...
public class UserDAOImpl implements UserDAO 
{
    ...
    @Override
    public boolean updateUser(String userName, String password, String name, String email, double phone, String city) {
        int count = jdbcTemplate.update(sqlUpdateUser, password, name, email, phone, city, userName);
        return count > 0;
    }
}
