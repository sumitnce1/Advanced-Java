...
public class MobilePhoneServiceImpl implements MobilePhoneService 
{
	...
	public MobilePhoneDTO updateMobileDetail(int mobileId, MobilePhoneDTO mobilePhoneDTO) {
		mobilePhoneRepository.updateMobileDetail(mobileId, mobilePhoneDTO.getPhoneName(), mobilePhoneDTO.getPhoneMemory(), mobilePhoneDTO.getPhoneOS(), mobilePhoneDTO.getPhoneSize());
